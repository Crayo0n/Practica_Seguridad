...
app = FastAPI(
    title="API de Biblioteca Digital v1",
    description="Versión 1: API de biblioteca sin seguridad",
    version="1.0"
)
...
def listar_libros(estado: str | None = None, db: Session = Depends(get_db)):
...
# Crear un nuevo usuario (Abierto en v1)
